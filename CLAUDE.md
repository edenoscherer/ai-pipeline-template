...
| `/docs-sync` | Atualiza incrementalmente `docs/features/<dominio>.md` a partir de uma spec concluída; chamado automaticamente pelo `/review-pr` Etapa 5 (só os Passos 1-3, sem o commit próprio) | atualização de doc de domínio | — |
